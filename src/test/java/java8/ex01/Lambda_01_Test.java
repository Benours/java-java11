...
public class Lambda_01_Test {
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        List<Person> result = filter(personList, x -> x.getFirstname().equals("first_10"));
    ...
    public void test_filter_by_password() throws Exception {
        ...
        List<Person> result = filter(personList, x -> x.getAge() > 49 && passwordSha512Hex.equals(DigestUtils.sha512Hex(x.getPassword())));
